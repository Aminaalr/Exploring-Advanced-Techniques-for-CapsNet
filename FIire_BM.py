...
def train(model, data, validation_data, class_names, args):
    # unpacking the data
    ...
    model.fit(train_generator(x_train, y_train, args.batch_size, args.shift_fraction),
              ...
              validation_steps=int(y_val.shape[0] / args.batch_size),
...
if __name__ == "__main__":
    ...
    if not args.testing:
        train(model=model, data=((x_train, y_train), (x_test, y_test)), validation_data=(x_val, y_val), class_names=classNames, args=args)
